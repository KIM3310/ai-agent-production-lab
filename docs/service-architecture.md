# Service Architecture - ai-agent-production-lab
...
- **Lane:** Agent production readiness
- **Primary buyer:** Teams moving agent prototypes into controlled operation
- **First motion:** Readiness assessment using fixture-based traces and cost-review reports

## Recommended Architecture

Static report gallery on GitHub Pages, Python CLI/lab in CI, optional API later for private readiness intake.
...
- GitHub Actions
- artifact storage
- optional OpenAI key for private runs

## Information Needed From Account Owner

- OPENAI_API_KEY only for private evals
- artifact storage token if used

## Cost and Risk Controls

- deterministic offline mode
- no private traces in public artifacts
- cost caps on API-backed evals
