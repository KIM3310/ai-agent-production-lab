# Revenue Architecture - ai-agent-production-lab
...
| Repo-specific launch path | Cloudflare Pages report site, Workers API for report generation, Supabase project/workspace data, OpenRouter/Groq for draft narratives with cached outputs |
