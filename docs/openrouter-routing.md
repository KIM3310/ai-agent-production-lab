...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `openai/gpt-5.4-mini` | Production readiness reports, incident drills, and architecture review notes. |
...
OPENROUTER_HTTP_REFERER=https://ai-agent-production-lab.pages.dev
OPENROUTER_APP_TITLE=ai-agent-production-lab
```
